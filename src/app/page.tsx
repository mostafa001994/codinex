    ...
    <div className="flex min-h-screen items-center justify-center font-sans //dark:bg-black">
      <main className="flex min-h-screen w-full max-w-7xl flex-col items-center justify-between bg-white ">
        ...
        <section className="w-full relative">
          ...
          <Image
            className="text-center absolute top-0 right-0"
            src="/lines.svg"
            alt="سایت فروشگاهی"
            width={600}
            height={600}
          ...
          <div className="flex md:flex-row flex-col-reverse gap-4 items-center justify-between">
            <div className="flex md:w-7/12 flex-col gap-10">
              <h3 className=" font-normal md:relative absolute md:top-auto top-0 text-cyan-700 p-3 rounded-2xl bg-blue-100 w-fit">
              ...
              <h2 className="lg:text-4xl w-full md:relative absolute md:top-0 top-20 md:text-3xl right-0 md:text-right text-center text-3xl font-extrabold text-[#3c416a]">
                سایت حرفه ای
                را خودتان بسازید
            ...
            <div className="md:w-5/12 w-full md:pt-0 pt-30">
        ...
        <section>
          ...
          <div className="bg-sky-50 p-10 rounded-4xl text-center ">
            ...
            <div className=" grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2  md:gap-8 gap-4 py-5">
        ...
        <section>
          ...
          <div className="lg:flex justify-between py-14">
            ...
            <div className="lg:w-5/12  w-11-12">
              ...
              <div className="website-sequrity w-9/12 h-96 m-auto my-10 overflow-y-clip bg-white relative shadow-2xl p-4 rounded-2xl flex flex-col gap-4 items-center">
                ...
                <div className="absolute bottom-20 md:-left-15 -left-8 shadow-2xl md:rounded-4xl rounded-3xl bg-white md:p-4 p-2 ">
                  <span className="flex gap-2 p-2 items-center">


                    <div className="text-gray-800 md:text-base text-sm cursor-pointer">
                      <span className="text-green-600">https://</span>
                      brandeshoma.ir
                    </div>
                    <span className=" fill-green-50 bg-green-600 p-1.5 rounded-lg">
                      <svg className="md:w-5 w-4 h-4 md:h-5 ">
                        <use href="#lock" />
                      </svg>
                    </span>
                  </span>
                  <p className="md:text-xs text-[9px] text-green-600 py-1">
            ...
            <div className="lg:w-5/12 w-11-12">
              ...
              <div className="google-webito w-9/12 h-96 m-auto my-10 bg-white relative shadow-2xl p-4 rounded-2xl flex flex-col gap-4 items-center">
                ...
                <div className="flex flex-col gap-3 lg:w-[120%] w-[120%] absolute -right-10 -left-10 bg-white  shadow-2xl p-4 rounded-3xl top-28">
                  ...
                  <hr />
                  <p className="text-gray-500 max-w-11-12">
